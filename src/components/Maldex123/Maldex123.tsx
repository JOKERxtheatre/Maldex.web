...
import Vectortop from "@/assets/Maldex3.png";
import Vectorbottom from "@/assets/Maldex4.png";

const Maldex123 = () => {
  return (
    <div className="Maldex123-section w-full mt-28 px-6 sm:px-4">
      <div className="Maldex123 w-full">
        <h1 className="text-3xl  text-[#0000B0] font-medium leading-[64px] sm:text-2xl  ">
        ...
        <div className="w-full flex flex-col items-start sm:flex 2xl:hidden">
          <div className="flex flex-col w-full items-center justify-center">
            <div className="Maldex123-row flex flex-col justify-between w-full max-w-[1180px] py-2 px-1.5 sm:gap-2.5">
        ...
        <div className="w-full flex flex-col items-start sm:hidden">
          <img
            src={VecTop}
            alt="img"
            className="w-[445px] h-[45px] translate-x-[595px]"
          />
          <div className="flex w-full items-center justify-center">
            <div className="Maldex123-row flex justify-between w-full max-w-[1180px] py-2">
              <div className="flex gap-6">
                <div className="w-[92px] h-[92px] flex items-center justify-center bg-[#E94B67] rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-zinc-300 ease duration-150">
                  <svg
                    width="41.000000"
          ...
          <img
            src={VecBottom}
            alt="img"
            className="w-[445px] h-[45px] translate-x-[155px]"
          />
        </div>
      </div>
    </div>
