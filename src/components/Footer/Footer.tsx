...
const Footer = () => {
  return (
    <div className="Footer-section flex items-center w-full justify-center mt-[136px] flex-col">
      <div className="Footer w-full flex flex-col">
        <FooterSlider />
        <div className="Footer-content flex flex-col p-6 bg-[#090909]">
          <div className="Footer-start w-full flex justify-between">
            <div className="flex flex-col gap-6">
              <h4 className="opacity-50 text-sm font-medium text-white">
                По всем вопросам
              </h4>
              <a
                href=""
                className="text-white text-5xl hover:underline underline-offset-[10px] font-medium leading-[50px]"
              >
                maldex <br />
                @info.com
              </a>
          ...
          <div className="Footer-end w-full mt-9 gap-6 flex flex-col">
