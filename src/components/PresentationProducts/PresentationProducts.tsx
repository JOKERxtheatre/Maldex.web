  ...
  return (
    <div className="PresentationProducts-section">
      <div className="PresentationProducts">
        <div className="PresentationProducts-header flex items-center justify-start h-[50px] px-10 border-b-2 border-opacity-[0.5] border-[#E1DFDA]">
        ...
        <div className="PresentationProducts-content w-full px-10 py-5 flex justify-center gap-2.5">
        ...
        <div className="PresentationProducts-content-2  w-full px-10 py-5 flex justify-center gap-2.5">
          <div>
            <PhotoSlider2 />
          </div>
